    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-1/2 bg-gradient-to-br from-blue-600 to-blue-700 p-12 flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 mt-20">
          <div className="bg-white rounded-3xl p-6 max-w-md shadow-2xl">
            ...
            <div className="space-y-3">
              <div className="flex items-center bg-gray-50 rounded-xl p-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-800 text-sm">Restaurant & Dining</p>
              ...
              <div className="flex items-center bg-gray-50 rounded-xl p-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-800 text-sm">Rent & Utilities</p>
            ...
            <div className="mt-4 inline-flex items-center bg-gradient-to-r from-green-400 to-emerald-500 rounded-full px-4 py-2">
              <span className="text-white text-xs font-semibold mr-2">On Track</span>
        ...
        <div className="relative z-10 text-center text-white">
          <h2 className="text-3xl font-bold mb-3">Take Control Of<br />Your Finances</h2>
          <p className="text-blue-200 text-sm">Track expenses, set budgets, and achieve<br />your financial goals with ease</p>
      ...
      <div className="w-1/2 bg-gray-50 flex items-center justify-center p-12">
        <div className="w-full max-w-md">
          ...
          {/* Heading */}
          <h1 className="text-3xl font-bold text-gray-800 text-center mb-2">Hello Again!</h1>
          <p className="text-gray-400 text-sm text-center mb-8">
            Welcome back! Sign in to continue tracking<br />your expenses and managing your budget
          </p>
          ...
          <div>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="text-blue-600 text-sm hover:underline">Recovery Password</button>
            </div>
            ...
            <button
              type="button"
              className="w-full bg-white border border-gray-200 text-gray-600 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
            >
